package com.project.razorpay.common.idempotency;

import com.project.razorpay.common.exception.IdempotencyConflictException;
...
public class IdempotencyFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response,
        ...
        try {
            ...
            if(status < 400 && bodyBytes.length > 0) {
                // Success - store the complete response for future replays
    ...
    private void replay(HttpServletRequest request, HttpServletResponse response, String stored) throws IOException {
        ...
        int seperatorIndex = stored.indexOf(SEPARATOR);
